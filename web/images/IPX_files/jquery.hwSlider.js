    ...
    HwSlider.prototype = {
        init: function(){
            ...
            if(self.options.arrShow){
                var arrElement = '<a href="javascript:;" class="arr prev iconfont icon-lArrow"></a><a href="javascript:;" class="arr next iconfont icon-rArrow"></a>';
